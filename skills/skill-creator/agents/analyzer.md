...
Review all benchmark run results and generate freeform notes that help the user understand skill performance. Focus on patterns that aggregate metrics alone wouldn't reveal.
